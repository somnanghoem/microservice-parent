package org.microservices.securityservice.util;
...
public class KeyUtils {
    ...
    private KeyPair getKeyPair(String publicKeyPath, String privateKeyPath) {
        ...
        File accessDirectory = new File("access-token-keys");
        if (!accessDirectory.exists()) {
            accessDirectory.mkdirs();
        }
        File refreshDirectory = new File("access-refresh-token-keys");
        if (!refreshDirectory.exists()) {
            refreshDirectory.mkdirs();
        }
        try {
            ...
            try (FileOutputStream fos = new FileOutputStream(publicKeyPath, false)) {
